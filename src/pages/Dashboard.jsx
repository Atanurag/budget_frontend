...
const Dashboard = () => {
  ...
  const onSubmit = () => {
    ...
    let summaryUrl = `https://budget-backend-2xm2.onrender.com/api/transaction/summary`;
  ...
  const onDelete = (id) => {
    ...
    setLoading(true);
    let deleteUrl = `https://budget-backend-2xm2.onrender.com/api/transaction/${id}`;
    ...
    },
    {
      ...
      render: (text, record) => (
        <FontAwesomeIcon
          ...
          icon={faPenToSquare}
          onClick={() => {
            navigate(`/transaction/edit/${record.key}`, { state: { propType: "Edit Transaction:" } });
            ;
          }}
        />
      ),
  ...
  return (
    <>
        ...
        <div className="info-card">
          ...
          <div className="info-card-content">
            ...
            <div className="info-card-value">
              ₹ {
                summaryInfo?.totalIncome > summaryInfo?.totalExpense
                  ? <CountUp
                    delay={1}
                    decimals={2}
                    separator=","
                    decimal="."
                    end={summaryInfo?.totalExpense}
                  />
                  : <>
                    <CountUp
                      delay={1}
                      ...
                      separator=","
                      decimal="."
                      end={summaryInfo?.totalExpense - summaryInfo?.totalIncome}
                    /> / ₹ <CountUp
                      delay={1}
                      decimals={2}
                      separator=","
      ...
      <div className="table-section">
        ...
        <Table columns={columns} dataSource={incomeList} pagination={{
          pageSize: 5,
      ...
      <div className="table-section">
        ...
        <Table columns={columns} dataSource={expenseList} pagination={{
          pageSize: 5,
          showSizeChanger: false
        }} />
      </div>
